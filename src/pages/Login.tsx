      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button
            ...
            className="w-full py-4 border border-white/10 rounded-lg flex items-center justify-center gap-3 text-white/60 hover:bg-white/5 transition-all text-xs font-bold uppercase tracking-widest"
          >
